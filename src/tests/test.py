...
def test_rag_pipeline():
    # Requires a sample PDF placed at this path (saved_files/ is gitignored,
    # generated by the app at runtime and not shipped in version control).
    documents = load_pdf(
        [r"saved_files\sample.pdf"]
    )
